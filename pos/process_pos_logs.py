...
if __name__ == '__main__':
    ...
    df['train_file'] = df['model'].apply(lambda x :os.path.basename(x.replace('/final_model', '')))
    df['eval_file'] =  df['eval_file'].apply(lambda x : os.path.splitext(os.path.basename(x))[0])
