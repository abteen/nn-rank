...
import ma_utils.pos_utils as pos_utils
# import ma_utils.pos_file_iso_maps.pos_lang_maps as pos_lang_maps
...
if __name__ == '__main__':
    ...
    for eval_file in tqdm(args.eval_files):
        ...
        eval_dataset = ConllPOSDataset(file=eval_file, tokenizer=tokenizer)
