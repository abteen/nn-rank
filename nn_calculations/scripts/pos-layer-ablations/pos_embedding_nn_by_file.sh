...
while IFS= read -r fname; do
    dir_to_read="/scratch/alpine/abeb4417/multilingual_analysis/layer_ablations/ud_hidden_reps_0/${model}/${target_split_name}/${fname}"
...
while IFS= read -r fname; do
    dir_to_read="/scratch/alpine/abeb4417/multilingual_analysis/layer_ablations/ud_hidden_reps_0/${model}/${source_split_name}/${fname}"
...
python embedding_nn_efficient.py \
    ...
    --experiment_name ud_pos_nn_sized_0 \
