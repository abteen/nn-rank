...
while IFS= read -r fname; do
    dir_to_read="/scratch/alpine/abeb4417/multilingual_analysis/ner_hidden_reps/${model}/${target_split_name}/${fname}"
...
python embedding_nn_efficient.py \
    ...
    --root_output_dir /scratch/alpine/abeb4417/multilingual_analysis/ner_nn_outputs/ \
    --experiment_name ner_nn_sized \
