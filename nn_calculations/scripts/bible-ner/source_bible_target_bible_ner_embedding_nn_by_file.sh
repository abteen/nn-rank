...
source_file_list_to_read="/projects/abeb4417/multilingual_analysis/ma_utils/bible_file_iso_maps/ner/langrank_bible_${source_split}_columns"
...
while IFS= read -r row; do
    ...
    dir_to_read="/scratch/alpine/abeb4417/multilingual_analysis/bible_ner_hidden_reps/${model}/${source_split_name}/${fname}"
...
python embedding_nn_efficient.py \
    ...
    --experiment_name source_bible_target_bible_ner_nn_sized \
