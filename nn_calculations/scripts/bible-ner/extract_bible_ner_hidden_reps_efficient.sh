...
for model_name in xlm-roberta-base bert-base-multilingual-cased; do
    for split in dev train; do
        ...
        bible_folders=/projects/abeb4417/multilingual_analysis/ma_utils/bible_file_iso_maps/ner/langrank_bible_${split}_all_columns
        echo ${bible_folders}
        ...
        python extract_hidden_reps_nn_efficient.py ${model_name} ${found_files} \
                    ...
                    --experiment_name bible_ner_hidden_reps \
