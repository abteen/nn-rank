...
target_file_list_to_read="/projects/abeb4417/multilingual_analysis/ma_utils/bible_file_iso_maps/pos/langrank_bible_${target_split}_columns"
source_file_list_to_read="/projects/abeb4417/multilingual_analysis/ma_utils/bible_file_iso_maps/pos/langrank_bible_${source_split}_columns"
...
while IFS= read -r row; do
    ...
    dir_to_read="/scratch/alpine/abeb4417/multilingual_analysis/bible_pos_hidden_reps/${model}/${target_split_name}/${fname}"
...
while IFS= read -r row; do
    ...
    dir_to_read="/scratch/alpine/abeb4417/multilingual_analysis/bible_pos_hidden_reps/${model}/${source_split_name}/${fname}"
...
python embedding_nn_efficient.py \
    ...
    --root_output_dir /scratch/alpine/abeb4417/multilingual_analysis/bible_pos_nn_outputs/ \
    --experiment_name source_bible_target_bible_pos_nn_sized \
