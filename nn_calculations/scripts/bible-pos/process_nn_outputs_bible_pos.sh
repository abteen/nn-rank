...
experiment=source_bible_target_bible_pos_nn_sized
            ...
            for train_split in train_all train_large train_medium; do
                for eval_split in dev_all; do 
                    for k in 5; do
                        ...
                        root_load_dir=/scratch/alpine/abeb4417/multilingual_analysis/bible_pos_nn_outputs/${experiment}/${model}/${layer}/${train_split}/${eval_split}/
                        i=0
                        ...
                        for target_lang_dir in "${root_load_dir}"/*; do 
                            ...
                            python process_nn_outputs.py \
                                ...
                                --method ${method} \
                                --k ${k} \
                                --save_dir bible_outputs/pos/${experiment}/${model}/${train_split}/${eval_split}/${method}/${layer}/k_${k}/
